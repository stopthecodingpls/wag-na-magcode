...
<body>
    ...
    <div class="containerr">
        <div class="rectangle-box">
            ...
            <form id="driver-info-form" action="driverinfohandlerTW1.php" method="POST">
        ...
        <div class="stacked-boxes">
            <div class="square-box1">
                <div class="box-content">
                    <div class="left">
                        <img src="toyota-wigo1.png" alt="Car Photo" class="photo">
                    </div>
                    <div class="right">
                        <p>Subcompact Hatchback</p>
                        <h1><strong>Toyota Wigo</strong></h1>
