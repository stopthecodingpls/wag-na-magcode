...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_SESSION['dropoff_date'] = $_POST['dropoff_date'];
}
...
$numDays = 0;
if ($pickup_date !== 'Not set' && $dropoff_date !== 'Not set') {
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item"><a class="nav-link" href="rnr.php#home">Home</a></li>
                <li class="nav-item"><a class="nav-link" href="rnr.php#service">Service</a></li>
                <li class="nav-item"><a class="nav-link" href="cars.php">Cars</a></li>
                <li class="nav-item"><a class="nav-link" href="pricing.php">Pricing</a></li>
                <li class="nav-item"><a class="nav-link" href="rnr.php#contact">Contact</a></li>
                <li class="nav-item"><a class="nav-link" href="rnr.php#about">About Us</a></li>
                <li class="nav-item">
                    <?php
    ...
    <div class="main-content">
        <div class="rectangle-box">
            <div class="rectangle-content">
                <div class="text-content">
                    ...
                    <div class="car-photo">
                        <img src="mitsubishi-mirage1.png" alt="Car Photo">
                    </div>
                    <div class="features">
                        <p>5 seats</p>
                        <p>Automatic</p>
        ...
        <div class="side-box">
            ...
            <h1><?php echo '₱ ' . ($numDays * 1500); ?></h1>
            <p>Mitsubishi Mirage</p>
            <hr class="separator">
        ...
        <div class="rectangle-box2">
            <div class="rectangle-content2">
                <div class="text-content2">
                    ...
                    <p>*The rented vehicle shall not be used to carry passengers or property for hire.<br>
                        *The rented vehicle shall not be used to carry passengers other than in the interior or cab of the vehicle.<br>
                        *The rented vehicle shall not be used to push, propel or tow another vehicle, trailer, or any other thing without written approval of the Owner.<br>
                        ...
                        *The Renter shall be fully responsible for all expenses relating to the rental car and any Vehicle involved in any type of accident.<br>
                        ...
                        *The Owner states that he/she is physically and legally qualified to operate the above-described vehicle.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        function redirectToNextPage() {
            window.location.href = "driverinfoM1.php";
        }
    </script>
